...
def init_arg_parser():
    ...
    arg_parser.add_argument('--parser', type=str, default='crsfn_parser', required=False, help='name of parser class to load')
    ...
    # TODO:currently only standard LSTM cell is supported  ?? parent_feed??
    arg_parser.add_argument('--lay_lstm', choices=['lstm'], default='lstm', help='Type of LSTM used, currently only standard LSTM cell is supported')
    ...
    arg_parser.add_argument('--lay_sup_attention', default=False, action='store_true', help='Use supervised attention')
    ...
    #parent information switch for lay decoder LSTM
    arg_parser.add_argument('--lay_no_parent_production_embed', default=False, action='store_true',
                            help='Do not use embedding of parent ASDL production to update decoder LSTM state')
    arg_parser.add_argument('--lay_no_parent_field_embed', default=False, action='store_true',
                            help='Do not use embedding of parent field to update decoder LSTM state')
    arg_parser.add_argument('--lay_no_parent_field_type_embed', default=False, action='store_true',
                            help='Do not use embedding of the ASDL type of parent field to update decoder LSTM state')
    arg_parser.add_argument('--lay_no_parent_state', default=True, action='store_true',
                            help='Do not use the parent hidden state to update decoder LSTM state')

    arg_parser.add_argument('--no_input_feed', default=False, action='store_true', help='Do not use input feeding in decoder LSTM')
    arg_parser.add_argument('--lay_no_input_feed', default=False, action='store_true', help='Do not use input feeding in decoder LSTM')
    ...
    arg_parser.add_argument('--lay_beam_size', default=5, type=int, help='Beam size for beam search')

    arg_parser.add_argument('--decode_max_time_step', default=100, type=int, help='Maximum number of time steps used '
                                                                                  'in decoding and sampling')
    arg_parser.add_argument('--lay_decode_max_time_step', default=100, type=int, help='Maximum number of time steps used '
                                                                                  'in decoding and sampling')
